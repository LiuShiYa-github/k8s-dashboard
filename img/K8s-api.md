<!-- TOC -->
  * [KubernetesAPI使用](#KubernetesAPI使用)
    * [API是什么](#API是什么)
    * [K8s认证方式](#K8s认证方式)
    * [示例](#示例)
      * [客户端库](#客户端库)
  ...
  * [网站布局](#网站布局)
    * [准备登录页面](#准备登录页面)
    * [登录认证集成RBAC](#登录认证集成RBAC)
    * [管理平台页面布局](#管理平台页面布局)
    * [命名空间选择](#命名空间选择)
  * [数据表格展示K8s常见资源](#数据表格展示K8s常见资源)
    * [Namespace](#Namespace)
    * [Node](#Node)
    * [PV](#PV)
  ...
  * [创建资源](#创建资源)
  * [查看和编辑YAML](#查看和编辑YAML)
  * [Node与Deployment详情页](#Node与Deployment详情页)
  * [容器终端与容器日志](#容器终端与容器日志)
    * [容器终端](#容器终端)
      * [前端模板](#前端模板)
      * [服务端](#服务端)
      * [前端](#前端)
      * [服务端DjangoChannels](#服务端DjangoChannels)
      * [小结](#小结)
    * [容器实时日志](#容器实时日志)
      * [路由](#路由)
      * [服务端](#服务端)
      * [前端模板](#前端模板)
      * [点击日志按钮与终端一样](#点击日志按钮与终端一样)
      * [添加Websocket路由](#添加Websocket路由)
      * [处理Websocket消费者](#处理Websocket消费者)
  * [仪表盘](#仪表盘)
<!-- TOC -->
